  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-6">
      <div className="max-w-4xl w-full space-y-8">
        <h1 className="text-6xl font-bold text-center mb-8 text-white">MasterClass</h1>
        ...
        <div className="text-center space-y-4 mt-8">
          <p className="text-xl text-gray-300">Welcome to MasterClass - Premium Educational Platform</p>
          ...
          <div className="space-y-2 text-lg pt-4">
            ...
            <p className="text-blue-400">✉️ ishimwekevin911@gmail.com</p>
          </div>
        </div>
      </div>
    </div>
