    ...
    <>
      ...
      >
        ...
        <div className="relative flex items-center justify-center mb-4" style={{ height: "160px", width: "200px" }}>
          <div
            className="absolute w-32 h-24 bg-yellow-600 rounded-lg shadow-md"
            style={{
          ...
          <div
            className="absolute w-12 h-4 bg-yellow-500 rounded-t-md"
            style={{
          ...
          <div
            className="absolute w-32 h-24 bg-yellow-400 rounded-lg shadow-lg"
            style={{
