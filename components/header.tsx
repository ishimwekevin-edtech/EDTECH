                ...
                <div className="grid grid-cols-3 gap-8">
                  <div>
                    ...
                    <div className="space-y-4">
                      ...
                      >
                        <div className="flex h-8 w-8 items-center justify-center bg-indigo-600 text-white rounded text-xs font-bold">
                          SF
                        </div>
                        <div>
                          ...
                          <div className="text-xs text-muted-foreground">Discover and connect with schools</div>
                        </div>
                      </a>
                      <a
